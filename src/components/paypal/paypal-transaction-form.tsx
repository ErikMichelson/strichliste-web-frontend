      ...
      <div>
        <form ref={formRef} action={BASE_URL} method="post">
          <Flex>
            ...
            <input type="hidden" name="business" value={settings.paypal.recipient} />
            <input type="hidden" name="item_name" value={`STRICHLISTE: ${props.userName}`} />
            ...
            <input type="hidden" name="currency_code" value={settings.i18n.currency.alpha3} />
            <AcceptButton margin="0 0 0 1rem" onClick={submit} disabled={!isValid} />
          </Flex>
        </form>
      </div>
      {fee && (
